...
const ConfirmedRide = (props) => {
  return (
    ...
    <h5 className='p-3 text-center  w-full left-4 top-2 absolute w-[90%] ' onClick={()=>{
      ...
      <button className='w-full bg-green-600 text-white font-semibold p-2 rounded  mt-5' onClick={()=>{props.setvehicleFound(true)
         props.setConfirmedRidePanel(false)}}>Confirm</button>
      </div>
      </>
  )
}
